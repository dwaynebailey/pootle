...
latex_documents = [
    ('index', 'Pootle.tex', 'Pootle Documentation',
     'Pootle contributors', 'manual'),
]
...
man_pages = [
    ('index', 'pootle', 'Pootle Documentation',
     ['Translate.org.za'], 1)
]
...
texinfo_documents = [
    ('index', 'Pootle', 'Pootle Documentation',
     'Pootle contributors', 'Pootle', 'Online translation tool.',
     'Miscellaneous'),
]
