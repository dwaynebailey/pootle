    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_pk', models.CharField(max_length=191, null=True, verbose_name='object ID', blank=True)),
                ('key', models.CharField(max_length=191, verbose_name='Configuration key', db_index=True)),
